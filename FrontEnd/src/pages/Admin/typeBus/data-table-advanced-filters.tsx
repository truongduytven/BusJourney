import { SlidersHorizontal, Layers, X } from "lucide-react";
...
interface AdvancedFiltersProps {
  isFloors: string;
  onIsFloorsChange: (value: string) => void;
  onReset: () => void;
}
...
export function DataTableAdvancedFilters({
  ...
  const hasActiveFilters = isFloors !== "all";

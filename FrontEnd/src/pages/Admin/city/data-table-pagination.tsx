          ...
          <div className="flex-1 text-sm text-muted-foreground">
            {selectedCount > 0 ? (
              <span className="font-medium text-primary">
                {selectedCount} trong số {totalRows} thành phố được chọn
              </span>
            ) : (
              <span>Tổng số {totalRows} thành phố</span>
            )}
          </div>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirmAction.type === "lock" &&
                `Bạn có chắc chắn muốn khóa ${selectedCount} thành phố đã chọn?`}
              {confirmAction.type === "unlock" &&
                `Bạn có chắc chắn muốn mở khóa ${selectedCount} thành phố đã chọn?`}
              {confirmAction.type === "export" &&
                `Bạn có muốn xuất ${selectedCount} thành phố đã chọn ra file Excel?`}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

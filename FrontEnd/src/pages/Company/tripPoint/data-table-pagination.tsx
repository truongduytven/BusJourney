          ...
          <div className="flex-1 text-sm text-muted-foreground">
            {selectedCount > 0 ? (
              <span className="font-medium text-primary">
                {selectedCount} trong số {totalRows} điểm đón/trả được chọn
              </span>
            ) : (
              <span>Tổng số {totalRows} điểm đón/trả</span>
            )}
          </div>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirmAction.type === "lock" &&
                `Bạn có chắc chắn muốn tạm dừng ${selectedCount} điểm đón/trả đã chọn?`}
              {confirmAction.type === "unlock" &&
                `Bạn có chắc chắn muốn kích hoạt ${selectedCount} điểm đón/trả đã chọn?`}
              {confirmAction.type === "export" &&
                `Bạn có muốn xuất ${selectedCount} điểm đón/trả đã chọn ra file Excel?`}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

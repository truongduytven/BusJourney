import { SlidersHorizontal, Bus as BusIcon, X } from "lucide-react";
...
interface AdvancedFiltersProps {
  typeBusFilter: string;
  onTypeBusFilterChange: (value: string) => void;
  onReset: () => void;
  typeBuses: TypeBus[];
}
...
export function DataTableAdvancedFilters({
  typeBusFilter,
  onTypeBusFilterChange,
  onReset,
  typeBuses,
}: AdvancedFiltersProps) {
  const hasActiveFilters = typeBusFilter !== "all";
      ...
      <DropdownMenuContent align="end" className="w-[280px]">
        ...
        <div className="space-y-4 p-4">
          <div className="space-y-2">
            ...
            <Select value={typeBusFilter} onValueChange={onTypeBusFilterChange}>

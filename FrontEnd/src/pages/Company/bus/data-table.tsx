...
interface DataTableProps {
  ...
  data: Bus[];
  isFloorsFilterValue: string;
  onIsFloorsFilterChange: (value: string) => void;
  onResetFilters: () => void;
  searchValue: string;
      ...
      <div className="flex flex-wrap items-center gap-2 py-5">
        ...
        <div className="ml-auto flex gap-x-4">
          <DataTableAdvancedFilters
            typeBusFilter={isFloorsFilterValue}
            onTypeBusFilterChange={onIsFloorsFilterChange}
